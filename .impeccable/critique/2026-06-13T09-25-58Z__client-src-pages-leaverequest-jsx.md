...
p0_count: 1
p1_count: 1
timestamp: 2026-06-13T09-25-58Z
...
* **Hero metric template**: The `.days-count` box uses a heavy purple-to-indigo gradient badge to highlight the day count, functioning as an over-styled hero metric on a clean form.
