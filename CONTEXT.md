...
- **Leave Status Lifecycle**:
  ...
  - `pending_dean` (รอความเห็นคณบดี): หัวหน้างานเห็นชอบและส่งต่อแล้ว รอคณบดีหรือผู้อำนวยการหน่วยงานพิจารณา
  - `pending_vp` (รอคำสั่งรองอธิการบดี): คณบดีหรือผู้อำนวยการเห็นชอบและส่งต่อแล้ว รอรองอธิการบดีฝ่ายบริหารงานบุคคลมีคำสั่ง
