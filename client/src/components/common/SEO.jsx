...
export const SEOConfig = {
  ...
  login: {
    title: "เข้าสู่ระบบ",
    description: "เข้าสู่ระบบบริหารการลางานของบุคลากร มหาวิทยาลัยราชภัฏบุรีรัมย์ (BRU Leave Management System)",
    keywords: "เข้าสู่ระบบ, ล็อกอิน, ระบบลา BRU, มหาวิทยาลัยราชภัฏบุรีรัมย์, BRU Leave Management",
    canonicalUrl: "https://leave-bru.vercel.app/login",
    noIndex: false,
  },
  forgotPassword: {
    title: "ลืมรหัสผ่าน",
    description: "ขอลิงก์ตั้งรหัสผ่านใหม่สำหรับระบบบริหารการลา มหาวิทยาลัยราชภัฏบุรีรัมย์ (BRU)",
    keywords: "ลืมรหัสผ่าน, กู้คืนรหัสผ่าน, ระบบลา BRU",
    canonicalUrl: "https://leave-bru.vercel.app/forgot-password",
    noIndex: false,
  },
  resetPassword: {
    title: "ตั้งรหัสผ่านใหม่",
    description: "ตั้งรหัสผ่านใหม่สำหรับระบบบริหารการลา มหาวิทยาลัยราชภัฏบุรีรัมย์ (BRU)",
    keywords: "ตั้งรหัสผ่านใหม่, รีเซ็ตรหัสผ่าน, ระบบลา BRU",
    noIndex: false,
  },
  forms: {
    title: "แบบฟอร์มการลา",
    description: "ดาวน์โหลดเอกสารและแบบฟอร์มการลาประเภทต่างๆ มหาวิทยาลัยราชภัฏบุรีรัมย์ (BRU)",
    keywords: "แบบฟอร์มการลา, ดาวน์โหลดใบลา, เอกสารการลา, มหาวิทยาลัยราชภัฏบุรีรัมย์, BRU",
    canonicalUrl: "https://leave-bru.vercel.app/forms",
    noIndex: false,
  },
  regulations: {
    title: "ระเบียบและข้อบังคับการลา",
    description: "คู่มือ ระเบียบ และข้อบังคับการลาของบุคลากร มหาวิทยาลัยราชภัฏบุรีรัมย์ (BRU)",
    keywords: "ระเบียบการลา, ข้อบังคับการลา, สิทธิการลา, มหาวิทยาลัยราชภัฏบุรีรัมย์, BRU",
    canonicalUrl: "https://leave-bru.vercel.app/regulations",
    noIndex: false,
  },
  register: {
    title: "ลงทะเบียนบุคลากร",
    description: "ลงทะเบียนเข้าใช้งานระบบบริหารการลางาน มหาวิทยาลัยราชภัฏบุรีรัมย์ (BRU)",
